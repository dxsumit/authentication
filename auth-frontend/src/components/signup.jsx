...
const Signup = () => {
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            await axios.post(`${baseURL}/auth/api/signup`, {name, age, email, password});
            reset()
    ...
    return (
        ...
        <div>
            ...
            <h1 className='font-bold text-2xl mb-8 w-5/6 lg:text-2xl pt-2' > Create account with GreenStitch.io </h1>
